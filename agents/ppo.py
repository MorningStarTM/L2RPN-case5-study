...
class SparseActorNetwork(nn.Module):
    def __init__(self, n_actions, input_dims, alpha,
            fc1_dims=512, fc2_dims=1024, chkpt_dir='models') -> None:
        super(SparseActorNetwork, self).__init__()
        self.checkpoint_file = os.path.join(chkpt_dir, 'sparse_actor_torch_ppo_14')
        ...
        self.actor = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Linear(fc2_dims, 2048),
            nn.ReLU(),
            nn.Linear(2048, fc2_dims),
            nn.ReLU(),
